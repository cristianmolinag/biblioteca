...
class DocenteController extends Controller
{
    ...
    {
        $data = User::where('tipo_usuario', '=', 'Docente')->get();
        return view('dashboard.docente.index', compact('data'));
    }

    public function create()
    {
        return view('dashboard.docente.nuevo');
    }
    ...
    public function store(Request $request)
    {
       $request->validate([
        ...
        return redirect()->route('docente.index')->with('message', 'Registro insertado con éxito!');          
    }

    public function edit($id){
        $data = User::find($id);

        return view('dashboard.docente.editar', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('docente.index')->with('message', 'Registro editado con éxito!');  
    }
}
