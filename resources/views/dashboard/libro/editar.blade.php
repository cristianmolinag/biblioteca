...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h5 class="text-titulo">Edición del libro {{ $datos['libro']->titulo }}</h5>
            <form method="POST" action="{{ route('libro.update', ['id' => $datos['libro']->id]) }}">
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input type="number" 
                            ...
                            value="{{ old('isbn', $datos['libro']->isbn) }}" 
                            id="isbn" 
                            name="isbn"
                    ...
                    <div class="col form-group">
                            ...
                            <input type="text" 
                                ...
                                value="{{ old('titulo', $datos['libro']->titulo) }}" 
                                id="titulo" 
                                name="titulo"
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <input type="text" 
                            ...
                            value="{{ old('anio', $datos['libro']->anio) }}" 
                            id="anio" 
                            name="anio"
                            maxlength="4"
                            pattern="\d*"
                        ...
                        <input type="text" 
                            ...
                            value="{{ old('numero_paginas', $datos['libro']->numero_paginas) }}" 
                            id="numero_paginas" 
                            name="numero_paginas"
                            maxlength="4"
                            pattern="\d*"
