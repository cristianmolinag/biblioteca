...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <h5 class="text-titulo">Listado de libros</h5>
            <div class="form-group">
                <a class="btn btn-success text-light float-md-right" href="{{ route('libro.nuevo') }}">
                    Nuevo registro
                </a>
            </div>
                ...
                <table class="table table-striped table-bordered" style="width:100%" id="tabla">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{!!$row->autor->nombres .' '. $row->autor->apellidos!!}</td>
                            <td>{!!$row->editorial->nombre!!}</td>
                            <td>{!!$row->categoria->nombre!!}</td>
                            <td class="text-center">
                            <a class="" href="{{ route('libro.edit', ['id' => $row->id]) }}">
                            Editar
                        </button>
                            </td>
                        </tr>
    ...
    <form method="POST" action="{{ route('libro.file') }}" enctype="multipart/form-data">
        <div class="row">
            @csrf
            <div class="col-md-6">
                <div class="form-group">
