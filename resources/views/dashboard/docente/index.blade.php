...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            @endif
            <h5 class="text-titulo">Listado de docentes</h5>
            <div class="form-group">
                <a class="btn btn-success text-light float-md-right" href="{{ route('docente.nuevo') }}">
                    Nuevo registro
                </a>
            </div>
                ...
                <table class="table table-striped table-bordered" style="width:100%" id="tabla">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <a class="" href="{{ route('docente.edit', ['id' => $usuario->id]) }}">
                            Editar
                        </button>
                            </td>
                        </tr>
